...
#define CUDA_SAFE_EXEC(val)           check ( (val), #val, __FILE__, __LINE__ )
...
{
    int device_count;
    CUDA_SAFE_EXEC(cudaGetDeviceCount(&device_count));
    ...
    CUDA_SAFE_EXEC(cudaGetDeviceProperties(&deviceProp, devID));
    ...
    CUDA_SAFE_EXEC(cudaSetDevice(devID));
...
inline bool checkCudaCapabilities(int major_version, int minor_version)
{
    ...
    CUDA_SAFE_EXEC(cudaGetDevice(&dev));
    CUDA_SAFE_EXEC(cudaGetDeviceProperties(&deviceProp, dev));
